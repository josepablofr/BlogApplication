package com.example.blogappjp.ui.home.adapter
...
import com.example.blogappjp.core.BaseViewHolder
import com.example.blogappjp.core.TimeUtils
import com.example.blogappjp.data.model.Post
import com.example.blogappjp.databinding.PostItemViewBinding
...
class HomeScreenAdapter(private val postList: List<Post>, private val onPostClickListener: OnPostClickListener):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<*> {
        ...
        return HomeScrenViewHolder(itemBinding, parent.context)
    }

    override fun onBindViewHolder(holder: BaseViewHolder<*>, position: Int) {
        when(holder){
            is HomeScrenViewHolder -> holder.bind(postList[position])
        }
    }

    override fun getItemCount(): Int = postList.size

    private inner class HomeScrenViewHolder(
